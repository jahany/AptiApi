...
namespace AptinetDataAccessLibrary.Migrations
{
    ...
    [Migration("20231222075708_editfactorlist1")]
    partial class editfactorlist1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AptinetDataAccessLibrary.Models.FactorList", b =>
                {
                    ...
                    b.Property<string>("productSaving")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("productTax")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("productTotalFinalPrice")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
